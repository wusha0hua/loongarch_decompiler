...
pub fn beqz(insn: AssemblyInstruction, irs: &mut Vec<Ir>) {
    ...
    let mut operand2 = ir::IrOperand::None;
    ...
    let ir = Ir::from(Some(insn.address), IrOpcode::JCC, condiction, operand2, next);
    irs.push(ir);
}
