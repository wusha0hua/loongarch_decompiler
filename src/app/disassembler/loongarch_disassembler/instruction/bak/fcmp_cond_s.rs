...
pub fn fcmp_cond_s(code: u32, address: usize, symbol: HashMap<usize, SymbolRecord>) -> AssemblyInstruction {
    let mut assembly_instruction = AssemblyInstruction::new();
    let mut operand = Operand {
        operand_type: OperandType::UnsignedImm,
        value: 0,
    };
    operand.value = ((code as usize) & 7);
    ...
    assembly_instruction.opcode = match ((code as usize >> 15) & ((1 << 5) - 1)) {
