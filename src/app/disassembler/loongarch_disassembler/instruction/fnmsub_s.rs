...
pub fn fnmsub_s(code: u32, address: u64, symbol: &HashMap<u64, SymbolRecord>) -> AssemblyInstruction {
	let mut assembly_instruction = AssemblyInstruction::new();
	assembly_instruction.opcode = Opcode::FNMSUB_S;
	...
	operand.value = (code as u64 >> 15) & ((1 << 5) - 1);
    assembly_instruction.regs_read.push(Register::FR(operand.value));
