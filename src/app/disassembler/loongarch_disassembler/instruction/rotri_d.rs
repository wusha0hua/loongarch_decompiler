...
pub fn rotri_d(code: u32, address: u64, symbol: &HashMap<u64, SymbolRecord>) -> AssemblyInstruction {
    let mut assembly_instruction = AssemblyInstruction::new();
    assembly_instruction.opcode = Opcode::ROTRI_D;
    ...
    operand.value = (code as u64 >> ((1 << 5) - 1)) & ((1 << 5) - 1);
